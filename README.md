...
- Era-accurate structures and cave biomes (on by default): no villages on Alpha, no ocean monuments before 1.8,
  no lush caves under 1.17 — each continent gets the structures and underground biomes its version had.
